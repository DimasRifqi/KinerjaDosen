                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="statistics-details d-flex align-items-center justify-content-between">
                                    <div>
                                        <p class="statistics-title">Dosen Yang Mengajukan</p>{{-- tooltip "Dosen Yang Mengajukan Di Periode Ini" --}}
                                    ...
                                    <div>
                                        <p class="statistics-title">Tunjangan Yang Diproses</p>{{-- tooltip "Pengajuan Tunjangan Yang Masih Diproses Saat Ini" --}}
                                        <h3 class="rate-percentage">123115</h3>
                                        <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>-0.5%</span>
                                        </p>{{-- tooltip "0.5% Lebih Sedikit dari Periode Semester Lalu" --}}
                                    </div>
                                    <div>
                                        <p class="statistics-title">Tunjangan Berhasil</p>{{-- tooltip "Pengajuan Berhasil Di Periode Ini" --}}
                                        <h3 class="rate-percentage">7,682</h3>
                                        <p class="text-success d-flex"><i
                                                class="mdi mdi-menu-up"></i><span>+0.1%</span>{{-- tooltip "0.1% Lebih Banyak dari Periode Semester Lalu" --}}
                                        </p>
                                    </div>
                                    <div class="d-none d-md-block">
                                        <p class="statistics-title">Lorem Ipsum</p>{{-- tooltip "Lorem Ipsum" --}}
                                        <h3 class="rate-percentage">123115</h3>
                                        {{-- <p class="text-success d-flex"><i class="mdi mdi-menu-down"></i><span>+0.8%</span></p> --}}
                                    </div>
                                    <div class="d-none d-md-block">
                                        <p class="statistics-title">Jumlah Perguruan Tinggi</p>{{-- tooltip "Jumlah Perguruan Tinggi Yang terdaftar" --}}
                                        <h3 class="rate-percentage">123115</h3>
                                        <p class="text-danger d-flex"><i
                                                class="mdi mdi-menu-down"></i><span>-68</span>{{-- tooltip "68 Lebih Sedikit dari Periode Semester Lalu" --}}
                                        </p>
                                    ...
                                    <div class="d-none d-md-block">
                                        <p class="statistics-title">Jumlah Dosen</p>{{-- tooltip "Jumlah Dosen Yang terdaftar" --}}
                                        <h3 class="rate-percentage">123115</h3>
                                        <p class="text-success d-flex"><i
                                                class="mdi mdi-menu-down"></i><span>+0.8%</span>{{-- tooltip "0.8% Lebih Banyak dari Periode Semester Lalu" --}}
                                        </p>
                                    </div>
                                </div>
                            </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-danger"> 35.00% <i
                                                                                class="ti-arrow-down"></i></td>
                                                                        <td><label class="badge badge-info">Fixed</label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Peter</td>
