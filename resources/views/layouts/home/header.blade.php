    ...
    <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                <h1 class="welcome-text">Hallo <span class="text-black fw-bold">CharLimit11</span></h1>
        ...
        <ul class="navbar-nav ms-auto">
            ...
            {{-- start: bagian ini ngebug, tidak dapat diklik untuk dropdown --}}
            ...
            {{-- end: bagian ini ngebug, tidak dapat diklik untuk dropdown --}}
