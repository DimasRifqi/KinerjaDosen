                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel">Sunting Bank</h5>
                        ...
                        <div class="modal-body">
                            <form id="editGelarBForm">
                                ...
                                <div class="form-group">
                                    <label for="edit_nama_gelar_belakang">Nama Bank</label>
                                    <input type="text" class="form-control" id="edit_nama_gelar_belakang"
                    ...
                    <div class="row">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-warning btn-sm edit-btn"
                                                            ...
                                                            data-status="{{-- {{ $gelar->status }} --}}" data-bs-toggle="modal"
                        ...
                        <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="createModalLabel">Buat Bank</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="createGelarBForm">
                                            @csrf
                                            <div class="form-group">
                                                <label for="nama_gelar_belakang">Nama Bank</label>
